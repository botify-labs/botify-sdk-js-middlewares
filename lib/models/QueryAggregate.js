...
var QueryAggregate = (function () {
  ...
  _createClass(QueryAggregate, [{
    ...
    value: function processResponse(aggResponse) {
      ...
      var _ref2$transformTermKeys = _ref2.transformTermKeys;
      var transformTermKeys = _ref2$transformTermKeys === undefined ? true : _ref2$transformTermKeys;
      var _ref2$injectMetadata = _ref2.injectMetadata;
      var injectMetadata = _ref2$injectMetadata === undefined ? true : _ref2$injectMetadata;
      var _ref2$normalizeBoolean = _ref2.normalizeBoolean;
      var normalizeBoolean = _ref2$normalizeBoolean === undefined ? true : _ref2$normalizeBoolean;
    ...
    value: function _processGroupResponse(groupResponse, _ref3) {
      ...
      var normalizeBoolean = _ref3.normalizeBoolean;
      ...
      return _extends({}, groupResponse, {
        key: groupResponse.key.map(function (keyItem, i) {
          return _this.groupBys[i].applyKeyReducers(keyItem, {
